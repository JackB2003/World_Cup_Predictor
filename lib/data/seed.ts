...
const userPicks = {
  ...
  streak: 4,
  top4: [
    { pos: 1, team: "ARG", status: "on-track" as const, note: "Reigning champions" },
    { pos: 2, team: "ESP", status: "on-track" as const, note: "Best ball progression" },
    { pos: 3, team: "FRA", status: "on-track" as const, note: "Elite transition attack" },
    { pos: 4, team: "BRA", status: "on-track" as const, note: "Individual quality" },
  ],
